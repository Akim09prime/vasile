...
// This is the Client Component that receives data via props
export default function HomePageContent({ lang, dictionary, homePageData }: { lang: Locale, dictionary: any, homePageData: any }) {
    ...
    <>
      <section className="relative h-[80vh] min-h-[600px] w-full flex items-center justify-center text-center">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="mt-6 max-w-2xl mx-auto text-lg text-foreground/80 md:text-xl">
      ...
      {valuePillars && 
        <section className="section-padding container-max">
            ...
            {valuePillars.pillars.map((pillar: any) => (
                <Card key={pillar.title} className="bg-card/80 border-border/50 text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <ul className="mt-8 space-y-3">
                        {guarantees.items.map((guarantee: any) => (
