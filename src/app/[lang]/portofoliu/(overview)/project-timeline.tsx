...
export function ProjectTimeline({
  ...
  const getProjectYear = (project: ProjectSummary) => {
        ...
        >
          ...
          {sortedYears.map((year, yearIndex) => (
            <React.Fragment key={year}>
              ...
              >
                <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-primary ring-8 ring-background z-20" />
                  ...
                  >
                    ...
                    <div className="pl-12 md:pl-0 md:p-8">
                       <div className="flex items-center gap-4 text-sm text-muted-foreground mb-2">
                            <span className="flex items-center gap-1.5"><Calendar className="w-4 h-4"/>{new Date(project.completedAt || project.publishedAt || project.createdAt).toLocaleDateString('ro-RO', { month: 'long', year: 'numeric'})}</span>
